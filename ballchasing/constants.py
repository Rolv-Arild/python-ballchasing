...
AnyPlaylist = str | Literal["unranked-duels", "unranked-doubles", "unranked-standard", "unranked-chaos", "private", "season",
...
AnyRank = str | Literal["unranked", "bronze-1", "bronze-2", "bronze-3", "silver-1", "silver-2", "silver-3", "gold-1",
...
class Season:
    ALL = (SEASON_1, SEASON_2, SEASON_3, SEASON_4, SEASON_5, SEASON_6, SEASON_7, SEASON_8, SEASON_9, SEASON_10,
           ...
           SEASON_12_FTP, SEASON_13_FTP) = get_args(AnySeason)
...
AnyMatchResult = str | Literal["win", "loss"]
...
AnyReplaySortBy = str | Literal["replay-date", "upload-date"]
...
AnyGroupSortBy = str | Literal["created", "name"]
...
AnySortDir = str | Literal["asc", "desc"]
...
AnyVisibility = str | Literal["public", "unlisted", "private"]
...
AnyPlayerIdentification = str | Literal["by-id", "by-name"]
...
AnyTeamIdentification = str | Literal["by-distinct-players", "by-player-clusters"]
